...
export default function AnimatedFeatureList({
  ...
  return (
    <section
      className={`relative flex flex-col items-center justify-center h-[200vh] py-16 md:py-24 bg-gradient-to-b from-transparent to-primary from-85% sm:from-80% ${className}`}
    >
      <div className="flex flex-col justify-center items-center px-8 max-w-7xl h-[calc(100vh-64px) sticky top-32">
